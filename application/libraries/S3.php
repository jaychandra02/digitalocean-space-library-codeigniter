...
class S3 {
    ...
    public static function setBucketLogging($bucket, $targetBucket, $targetPrefix = null) {
        ...
        $bucketLoggingStatus->setAttribute('xmlns', 'http://sgp1.digitaloceanspaces.com/doc/2006-03-01/');
    ...
    public static function getAuthenticatedURL($bucket, $uri, $lifetime, $hostBucket = false, $https = false) {
        ...
        return sprintf(($https ? 'https' : 'http') . '://%s/%s?AWSAccessKeyId=%s&Expires=%u&Signature=%s',
                $hostBucket ? $bucket : $bucket . '.sgp1.digitaloceanspaces.com', $uri, self::$__access_key, $expires,
    ...
    public static function createDistribution($bucket, $enabled = true, $cnames = array(), $comment = '') {
        ...
        $rest->data = self::__getCloudFrontDistributionConfigXML($bucket . '.sgp1.digitaloceanspaces.com', $enabled, $comment, (string) microtime(true), $cnames);
        $rest->size = strlen($rest->data);
        $rest->setHeader('Content-Type', 'application/xml');
...
final class S3Request {
     ...
     * @return mixed
     */
    function __construct($verb, $bucket = '', $uri = '', $defaultHost = 'sgp1.digitaloceanspaces.com') {
        $this->verb = $verb;
